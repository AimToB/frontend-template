...
declare const Link: react.ForwardRefExoticComponent<Omit<{
    ...
    locale?: use_intl.Locale | undefined;
...
declare const redirect: (args: {
    href: string | {
        pathname: string;
        query?: next_intl_navigation.QueryParams;
    };
    locale: use_intl.Locale;
    forcePrefix?: boolean;
}, type?: next_navigation.RedirectType | undefined) => never;
declare const usePathname: () => string;
declare const useRouter: () => {
    push: (href: string | {
        pathname: string;
        query?: next_intl_navigation.QueryParams;
    }, options?: (Partial<next_dist_shared_lib_app_router_context_shared_runtime.NavigateOptions> & {
        locale?: use_intl.Locale;
    }) | undefined) => void;
    replace: (href: string | {
        pathname: string;
    ...
    prefetch: (href: string | {
        pathname: string;
        query?: next_intl_navigation.QueryParams;
    }, options?: (Partial<next_dist_shared_lib_app_router_context_shared_runtime.PrefetchOptions> & {
        locale?: use_intl.Locale;
    }) | undefined) => void;
    back(): void;
    forward(): void;
